...
# from src.gathering_data.dynamodb import Dynamodb
from src.utils.athena import Athena
from src.utils.session import boto

from src.utils.project_paths import ABI_PATH, DATA_PROCESSED, DATA_RAW, FILES_PATH
